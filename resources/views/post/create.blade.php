    ...
    <div class="mx-4 sm:p-8">
        <form method="post" action="{{ route('post.store') }}" enctype="multipart/form-data">
            ...
            <div class="md:flex items-center mt-8">
                ...
                <label for="title" class="font-semibold leading-none mt-4 text-white">件名</label>
            ...
            <div class="w-full flex flex-col">
                <label for="body" class="font-semibold leading-none mt-4 text-white">本文</label>
                <textarea name="body" class="w-auto py-2 border border-gray-300 rounded-md" id="body" cols="30" rows="10">{{old('body')}}</textarea>
            </div>

            <div class="w-full flex flex-col">
                <label for="image" class="font-semibold leading-none mt-4 text-white">画像（1MBまで） </label>
                <div>
